...
const EditUser = () => {
  ...
  const onSubmitHandle = async (e) => {
    ...
    setUpdating(true);
    await axios
      .post("https://react-crud-backend.onrender.com/update", user, {
        headers: {
          "Content-Type": "application/json",
        },
      })
    ...
    <div>
      <div>
        <Modal show={show}>
          ...
          <Modal.Body>Student Data updated Succesfully</Modal.Body>
          <Modal.Footer>
      ...
      {loading ? (
        <div className="container px-4">
          <div className="container py-3 border mt-2 ">
            <h3 className="text-center mb-5 mt-2 font-weight-light text-uppercase">
              Edit Student's data
            </h3>
